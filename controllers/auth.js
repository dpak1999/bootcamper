...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  if (!user) {
    return next(
      new ErrorResponse("There is no such user associated with that email", 404)
    );
  }
  ...
  has requested for password reset. Please make a put request to: \n\n ${resetUrl}`;
